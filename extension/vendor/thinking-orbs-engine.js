/* thinking-orbs 0.3.1 engine (MIT) — https://github.com/Jakubantalik/thinking-orbs
 * Vendored without React. Official Thinking state is `breathing` / ring. */
var ThinkingOrbs = (function () {
function U(n, s, t) {
  return n + (s - n) * t;
}
function nt(n) {
